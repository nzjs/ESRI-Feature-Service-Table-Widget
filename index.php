...
<html lang="en">
  ...
  <body>
    ...
    <form method="get" action="view-table.php" class="form-signin" name="form"><br/>
        ...
        <img class="mb-4" src="https://wcrc.maps.arcgis.com/sharing/rest/content/items/6e7eb18cd1984ba5a897294f44fc111e/data" alt="" height="72">
          <h1 class="h3 mb-3 font-weight-normal">ESRI Feature Service Table Widget</h1>
          <p>Enter the ESRI hosted Feature Service URL that you want to generate a data table for.<br/><br/>
          <small>An interface featuring a data table for the feature layer will appear on the page. <br/>
          Once your data table URL is generated, you can add it as "Embedded Content" in an Operations Dashboard.<br/>
          It also supports filtering by a feature ID, by changing the &feature=1 to &feature={OBJECTID} (filtering described below).<br/>
          Use these parameters &rarr; Type: Feature, Content Type: Document, URL: [URL of gallery]&feature={OBJECTID}</small><br/><br/>
        ...
        <div class="form-group">
        <label for="theme">Theme selection (default Operations Dashboard themes)</label>
        ...
        <div class="form-label-group">
          <input type="text" name="feature" class="form-control" placeholder="1" value="1" style="min-width: 600px;" hidden>
        </div>

        <button class="btn btn-lg btn-primary btn-block" onclick="Submit()" style="min-width: 600px;" >Generate Table URL</button>
